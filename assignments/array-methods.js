...
// Problem 1 : Get everyone's email address
...
// Problem 2 return runners with Xs shirt should start last as they may be faster
let xs = 
runners.filter (function(xsmall){
     return xsmall.shirt_size ===  "XS"; 
});
console.log(xs);

// Problem 3 = The company Voolia got caugh running through a park and are disqualified
let disqualify = 
runners.filter (function(dq){
     return dq.company_name ===  "Voolia"; 
});
